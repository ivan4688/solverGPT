...
SYS_INLINE = (
    ...
    "Все математические вычисления, формулы, решения задач представляй в виде блоков кода"
    "Если не уверен в факте — напиши 'Не уверен'.\n"
)
...
def build_model_prompt(text: str, model: str, file_path: Optional[str] = None) -> dict:
    ...
    if file_path and os.path.exists(file_path):
        try:
            import utils.getdoc as u
            from utils.test_OCR import analyze_test_image
